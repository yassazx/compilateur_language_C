...
// Structure Instruction: contient l'instruction et sa ligne
...
// Fonction pour supprimer le premier element de la liste chainé
...
// Fonction pour vider une liste chainé
...
// Fonction pour ajouter un element a la fin d'une liste chainé
...
// Fonction pour afficher une liste chainé
...
// Fonction pour faire une analyse lexicale pour un mot depuis un dictionnaire
...
// Fonction pour lire un fichier, extraire les mots(instructions) and faire analyse lexicale pour chaque mot
...
// Fonction pour analyse syntaxique.
...
// Fonction pour lire un fichier, extraire les mots(instructions) et analyser syntaxiquement
